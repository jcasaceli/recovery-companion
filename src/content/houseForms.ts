/**
 * Ready-made sober-living operator forms (adapted from a common operator packet
 * into fillable, e-signable mobile forms). Facilitators pick a form, fill in the
 * resident/house details, and the resident (or facilitator) e-signs it.
 *
 * GENERIC BY DESIGN: no house name, address, dollar amount, curfew time, or other
 * house-specific detail is hard-coded. Anything that varies by house is either a
 * fillable field (house name, fees, dates) or phrased as "as set/posted by the
 * House," so a single template works for any operator.
 *
...
const definitionOfTerms: BuiltInTemplate = {
  ...
  fields: [
    ...
    { key: 'p_contribution', label: 'Contribution: The money given to the house by each resident is considered a contribution to the house. Make sure your residents understand that they do not pay rent and therefore do not receive formal eviction processes.', type: 'paragraph' },
    { key: 'p_resident', label: 'Resident: The women and/or men that join the house are considered residents in the home. As such, they agree not to have any "renter’s rights" and may be removed at any time for violating the contract/agreement, dirty test, refusing to test, etc.', type: 'paragraph' },
    { key: 'p_hoh', label: 'Head of House: The owner or a resident chosen to oversee daily function of the home. They may be used to resolve minor conflicts within the house before they escalate. This term is to be used instead of "Manager."', type: 'paragraph' },
    { key: 'p_meetings', label: 'House Meetings: A meeting with all residents in the house facilitated by staff or the Head of House to resolve house issues.', type: 'paragraph' },
    { key: 'p_cards', label: 'Meeting Cards: Used to track the NA/AA or other meetings residents attend. These can be shown to officials (code enforcement, etc.) upon request.', type: 'paragraph' },
    { key: 'p_staff', label: 'Staff: This term may be used to describe the owner, the Head of House, or someone designated to help facilitate the home.', type: 'paragraph' },
    { key: 'p_testlog', label: 'Test Log: Used for tracking the drug and/or alcohol testing of residents. This can be shown to officials (code enforcement, etc.) upon request.', type: 'paragraph' },
    { key: 'p_contriblog', label: 'Contribution Log: Used for tracking the contributions made by residents.', type: 'paragraph' },
  ],
};
...
const guestAgreement: BuiltInTemplate = {
  ...
  fields: [
    ...
    { key: 'acceptance_fee', label: 'Guest acceptance fee ($)', type: 'number', required: false },
    { key: 'drug_test_fee', label: 'Drug testing fee ($)', type: 'number', required: false },
    ...
    { key: 'p_acceptance', label: 'I agree to pay the Guest acceptance fee entered above, as well as a non-refundable drug testing fee (in the amount entered above) charged periodically as set by the House, which covers standardized on-site drug tests. All other designer drug tests will be sent to a certified lab at my sole expense and are payable upon testing. The Guest acceptance fee is refundable provided I give two weeks written notice of vacating and maintain continuous sobriety throughout my stay. I am financially responsible for fourteen days from my notice to vacate. If I fail to give two weeks written notice, I forfeit the acceptance fee and agree to pay the remaining fees to cover those fourteen days. If I fail to maintain continuous sobriety, my acceptance fee will be forfeited. If I am allowed to remain a guest, a new acceptance fee in the same amount will be required and all provisions of this Agreement remain in force.', type: 'paragraph' },
    { key: 'init_acceptance', label: 'Initial: I understand and agree', type: 'initial', required: true },
    { key: 'p_payment', label: 'The House accepts cash and any other payment methods it designates. Personal checks, if accepted, must be received in advance of the due date. Returned checks, late payments, and continued delinquency are subject to fees and consequences as set by the House and its posted policies. Non-payment beyond the grace period set by the House results in termination of this Agreement, and I must immediately vacate the premises.', type: 'paragraph' },
    ...
    { key: 'p_pol_1', label: '1. Noise: No loud music or television. Keep noise down during the quiet hours posted by the House. Be respectful and courteous of neighbors and others.', type: 'paragraph' },
    { key: 'p_pol_2', label: '2. Visitors: Entertained in community areas ONLY, during the visitation hours posted by the House, and not in guest bedrooms unless prior permission is granted. No overnight visits. You are responsible for your visitors’ behavior, and they must abide by the same rules and policies.', type: 'paragraph' },
    { key: 'p_pol_3', label: '3. No Smoking or Vaping: Not inside any unit. Smoking or vaping is allowed ONLY in the designated outdoor smoking area.', type: 'paragraph' },
    ...
    { key: 'p_pol_8', label: '8. Curfews: Observe the curfew posted by the House. No leaving after curfew unless approved by staff.', type: 'paragraph' },
    ...
    { key: 'p_pol_10', label: '10. Sleeping: Be awake and out of bed by the time posted by the House. No sleeping in community areas or on couches. Do not leave televisions/radios on in guest rooms while sleeping.', type: 'paragraph' },
    ...
    { key: 'p_pol_12', label: '12. Meeting Attendance: Meetings are to be attended as required by the House unless pre-approved by staff. Attendance slips may be required, signed and turned in.', type: 'paragraph' },
    ...
    { key: 'p_pol_16', label: '16. Overnight Passes: No pass until you have the minimum period of continuous sobriety set by the House. After that, you may apply for overnight passes per House policy, submitted in advance with written staff approval; chores must be completed and covered. No pass if you received a write-up within the previous seven days.', type: 'paragraph' },
    ...
    { key: 'p_pol_20', label: '20. Exercise Area: Use of exercise equipment is limited to the hours posted by the House.', type: 'paragraph' },
    ...
    { key: 'p_card_9', label: '9. Noise: No loud or disruptive equipment use during the quiet hours posted by the House.', type: 'paragraph' },
    { key: 'p_card_10', label: '10. Visitors: No unauthorized visitors on the property at any time unless first cleared with staff.', type: 'paragraph' },
...
const intakeInformation: BuiltInTemplate = {
  ...
  fields: [
    ...
    { key: 'p_stay', label: 'There is no limit to your stay as long as you follow the rules and pay your contributions on time. You begin on an initial probationary period set by the House. Observe the curfew posted by the House.', type: 'paragraph' },
    { key: 'p_visitors', label: 'Visitors (no one under 18). You are responsible for your visitors. They must be sober, visit only during posted visiting hours, are not allowed in bedrooms, and no sexual activity is allowed on the property.', type: 'paragraph' },
    { key: 'p_laundry', label: 'Laundry is done during the posted laundry hours — check if anyone is showering first. Wash your dishes immediately after eating; don’t leave dishes soaking; pour grease in provided containers, not down the drains; no dishes outside.', type: 'paragraph' },
    ...
    { key: 'p_meetings', label: 'You are required to attend all house meetings and participate in recovery-related programs/meetings. No smoking in any building — put butts in provided containers. No pets of any kind. A key deposit set by the House may be required.', type: 'paragraph' },
    ...
    { key: 'p_respect', label: 'Keep the pool gate closed (if applicable). You may notice others are "stand-offish" until they get to know you. Respect others and their property — if it’s not yours, don’t touch it; ask. Other than tobacco, if you have to be 18 or older to buy it, it’s not allowed. No drugs, alcohol, pornography, acts or threats of violence, etc. No tattooing.', type: 'paragraph' },
...
/** Templates that make sense as house-level (not tied to one resident). */
export const HOUSE_LEVEL_FORM_KEYS = ['head_of_house_agreement', 'definition_of_terms'];
