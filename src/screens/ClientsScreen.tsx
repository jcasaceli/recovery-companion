...
const styles = StyleSheet.create({
  ...
  houseChip: { paddingHorizontal: spacing.lg, paddingVertical: spacing.sm + 6, borderRadius: radius.pill, backgroundColor: colors.surfaceAlt, marginRight: spacing.sm, marginBottom: spacing.sm, borderWidth: 1, borderColor: colors.border, minHeight: 48, justifyContent: 'center' },
  ...
  houseChipText: { fontSize: 16, color: colors.textSecondary, fontWeight: '700' },
