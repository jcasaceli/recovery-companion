  ...
  <div style="font-family:Inter,Arial,sans-serif;max-width:560px;margin:0 auto;color:#2b2b2b">
    ...
    <div style="border:1px solid #e3e0d9;border-top:0;border-radius:0 0 14px 14px;padding:24px;line-height:1.6">
      ...
      <p style="margin:0 0 16px;background:#E4F1ED;border-radius:10px;padding:16px;text-align:center">
        ...
        <a href="https://soberlivingcompanion.com/docs" style="display:inline-block;margin-top:10px;color:#2F6B5F;font-weight:700;text-decoration:none">📖 Read the full how-to guide →</a>
      </p>
